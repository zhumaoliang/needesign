...
//					}
					...
					.each(
							...
							.each(
									works,
									function(index, ob) {
										htmlList+='<a href="'+ob.originalWork+'" target="_blank" style="text-decoration:none;"><img src="'+ob.thumbnailWork+'" width="100" height="100" alt=""/></a>&nbsp;&nbsp;';
									});
							htmlList+='</td>';
...
function getWorkById(id){
		$.ajax({
			url : app_path + 'workList/getWorkById',// 跳转到Login.action
			data : {
				id:id
			},
			type : 'post',
			...
			success : function(data) {
				if (data.rtnCode == "000000") {
					...
					$("#micpic").empty();
					$("#sbigpic").empty();
					 var works = data.responseData.works;
					 var htmlbigInfo='';
					 var htmlminInfo='';
					 var htmlsbigInfo='';
					 $
						.each(
								works,
								function(index, obj) {
									htmlbigInfo+='<li><a href="javascript:;"><img src="'+obj.originalWork+'" width="500" height="500" alt=""/></a></li>';
									htmlminInfo+='<li><a href="javascript:;"><img src="'+obj.thumbnailWork+'" width="500" height="500" alt=""/></a></li>';
									htmlsbigInfo+='<li><a href="javascript:;"><img src="'+obj.originalWork+'" width="500" height="500" alt=""/></a></li>';
									
								});
					
					 $("#bigpic").append(htmlbigInfo);
						$("#micpic").append(htmlminInfo);
						$("#sbigpic").append(htmlsbigInfo);
				} else{
					return;
				}
			}
